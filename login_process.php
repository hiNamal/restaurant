...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // For simplicity, we will compare the plain text password in this example
...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <a class="nav-link" href="#" class="navbar-brand"><img src="images/n-logo.png" height="45px"></a>
